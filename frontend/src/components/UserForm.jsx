...
function UserForm({ header, handleFunction,redirect,btnName, loader,currUser }) {
  const [user, setUser] = useState({
    name: currUser?.name || "",
    email: currUser?.email || "",
    password:currUser?.password || "",
    role:currUser?.role._id || null,
  });
      ...
      <div className="login_form_container">
        <div className="left">
          ...
          >
            ...
            >
              {loader ? "loading" : btnName}
            </button>
          </form>
        </div>
        <div className="right">
          <Link to={redirect || "/admin/dashboard"}>
            <button
              type="button"
